 ...
 *
 */
public class MyArrayList_v2 extends ArrayList<ProjektNormy_v2> implements Serializable {
	 ...
	 * @param doUsuniecia
	 */
	public void usunProjekty(MyArrayList_v2 doUsuniecia){
	 ...
	 */
	public void dodajListe(MyArrayList_v2 doDodania){
	...
	public void ustawAkredytacjaZharmonizowane(String plikAkredytacja, String plikAkredytacjaZC, String plikZharmonizowane){
		...
		for(int i = 0; i < this.size(); i++){
			this.get(i).uzupelnijAkredytacjaZharmonizowane(plikAkredytacja, plikAkredytacjaZC, plikZharmonizowane);
		}		
	 ...
	 */
	public void sortuj(){
		Collections.sort(this, new Comparator<ProjektNormy_v2>(){
			public int compare(ProjektNormy_v2 a, ProjektNormy_v2 b){
				int result = 0;
